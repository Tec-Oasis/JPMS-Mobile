...
class PropertyDescriptionPage extends StatelessWidget {
  ...
  const PropertyDescriptionPage({Key? key, required this.propertyId}) : super(key: key);
  ...
  Future<void> _applyForProperty(BuildContext context, Property property) async {
    final user = FirebaseAuth.instance.currentUser;

    if (user == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('You need to be logged in to apply for a property')),
      );
      return;
    }
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: const LinearGradient(
                              colors: [Colors.blue, Color.fromRGBO(60, 77, 161, 1)],
